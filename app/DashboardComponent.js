                            ...
                            <Card noShadow={true} transparent={true}>
                                ...
                                <CardItem style={styles.cardItem}>
                                    <View style={{ width: width / 2, alignItems: 'center' }}>
                                        <Button transparent style={{ width: width / 2, justifyContent: 'center' }}>
                                            <Text style={styles.samsungSans}> {'Followers'}</Text>
                                        </Button>
                                    </View>
                                    {/* <View style={{ width: width / 3, alignItems: 'center' }}>
                                        <Text style={styles.samsungSans}>{'|'}</Text>
                                    </View> */}
                                    <Button transparent style={{ width: width / 2, justifyContent: 'center' }}>
                                ...
                                <CardItem style={styles.cardItem}>
                                    <View style={{ flexDirection: 'row', flex: 1, width: width, justifyContent: 'space-around', backgroundColor: 'red', borderRadius: 5 }}>
                                        <View style={{ width: width / 3, height: 200, alignItems: 'center' }}>
                                        ...
                                        <View style={{ width: width / 3, height: 200, flex: 1, alignItems: 'center' }}>
